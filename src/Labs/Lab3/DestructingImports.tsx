    ...
    <div id='wd-destructuring-imports'>
      ...
      <table className='table table-sm'>
        ...
        <tbody>
          ...
          <tr>
            <td>Math.multiply(5, 1) = {Math.multiply(5, 1)}</td>
            <td>Matematica.multiply(5, 1) ={Matematica.multiply(5, 1)}</td>
            <td>multiply(5, 1) = {multiply(5, 1)}</td>
          </tr>
          <tr>
            <td>Math.divide(6, 3) = {Math.divide(6, 3)}</td>
            <td>Matematica.divide(6, 3) ={Matematica.divide(6, 3)}</td>
